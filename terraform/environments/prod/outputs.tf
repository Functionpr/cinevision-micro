...
output "dr_rds_security_group_id" {
  value = module.dr_vpc.rds_security_group_id
}

output "dr_documentdb_security_group_id" {
  value = module.dr_vpc.documentdb_security_group_id
}

output "dr_msk_security_group_id" {
  value = module.dr_vpc.msk_security_group_id
}
